...
export const MindWire启用或禁用文档思维导线 = winHotkey("ctrl+alt+o", "MindWire doc", "iconWire", () => tomatoI18n.启用或禁用文档思维导线, false, mindWireDocMenu) // 2026-09-06 撞键清理：原 ctrl+shift+z 撞官方 redo；⌥⌘O（H 有 macOS 系统键嫌疑，见上）
