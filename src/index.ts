...
// 注释切换（puncttidy □3 2026-09-10 seller 迁入）：默认 ⇧⌥\ 沿用 seller 键——官方 keymap
// （默认+用户自定义层）与全仓 winHotkey 清单实证无冲突（6810 活实例扫描 09-10）
