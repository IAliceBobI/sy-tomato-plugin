...
export const exportWL4All = settingFactory("exportWL4All", true, STORAGE_SETTINGS, null as TSK);
...
export const btnViewContents = settingFactory("btnViewContents", false, STORAGE_Prog_SETTINGS, null as TSK);
...
export const btnCleanOriginText = settingFactory("btnCleanOriginText", false, STORAGE_Prog_SETTINGS, null as TSK);
export const btnFullfilContent = settingFactory("btnFullfilContent", false, STORAGE_Prog_SETTINGS, null as TSK);
export const btnStop = settingFactory("btnStop", false, STORAGE_Prog_SETTINGS, null as TSK);
export const btnNextBook = settingFactory("btnNextBook", false, STORAGE_Prog_SETTINGS, null as TSK);
export const btnOpenFlashcardTab = settingFactory("btnOpenFlashcardTab", false, STORAGE_Prog_SETTINGS, null as TSK);
export const btnDeleteBack = settingFactory("btnDeleteBack", false, STORAGE_Prog_SETTINGS, null as TSK);
export const btnDeleteNext = settingFactory("btnDeleteNext", false, STORAGE_Prog_SETTINGS, null as TSK);
export const btnSaveCard = settingFactory("btnSaveCard", false, STORAGE_Prog_SETTINGS, null as TSK);
export const btnDelCard = settingFactory("btnDelCard", false, STORAGE_Prog_SETTINGS, null as TSK);
export const btnDeleteExit = settingFactory("btnDeleteExit", false, STORAGE_Prog_SETTINGS, null as TSK);
export const btnIgnoreBook = settingFactory("btnIgnoreBook", false, STORAGE_Prog_SETTINGS, null as TSK);
