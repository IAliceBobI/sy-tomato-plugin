...
export const cardBoxBuildSupCard = settingFactory("cardBoxBuildSupCard", true, STORAGE_SETTINGS, null as TSK);
...
export const linkBoxLnkTitle = settingFactory("linkBoxLnkTitle", true, STORAGE_SETTINGS, null as TSK);
...
export const dailyNoteCopy = settingFactory("dailyNoteCopy", false, STORAGE_SETTINGS, null as TSK);
...
export const mixBoxAddAlias = settingFactory("mixBoxAddAlias", false, STORAGE_SETTINGS, null as TSK);
...
export const doubleClick2DigestDesktop = settingFactory("doubleClick2DigestDesktop", true, STORAGE_Prog_SETTINGS, null as TSK);
...
export const summaryEnable = settingFactory("summaryEnable", false, STORAGE_Prog_SETTINGS, null as TSK);
export const pieceMoveEnable = settingFactory("pieceMoveEnable", false, STORAGE_Prog_SETTINGS, null as TSK);
